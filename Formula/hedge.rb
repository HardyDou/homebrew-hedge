class Hedge < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/HardyDou/hedge/releases/download/v1.9.2/hedge-cli-macos-arm64.tar.gz"
  ...
  on_linux do
    url "https://github.com/HardyDou/hedge/releases/download/v1.9.2/hedge-cli-linux-x64.tar.gz"
